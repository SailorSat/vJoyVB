...
' General driver data
Public Declare Function vJoyEnabled Lib "vJoyVB.dll" () As Boolean
...
Public Declare Function AcquireVJD Lib "vJoyVB.dll" (ByVal rID As Long) As Boolean
Public Declare Sub RelinquishVJD Lib "vJoyVB.dll" (ByVal rID As Long)
Public Declare Function UpdateVJD Lib "vJoyVB.dll" (ByVal rID As Long, ByRef pData As JOYSTICK_POSITION_V2) As Boolean
...
Public Declare Function ResetVJD Lib "vJoyVB.dll" (ByVal rID As Long) As Boolean
